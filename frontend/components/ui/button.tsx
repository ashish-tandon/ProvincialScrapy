  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        gradient:
          "bg-gradient-to-r from-primary to-purple-600 text-primary-foreground shadow-md hover:shadow-lg hover:scale-[1.02] active:scale-[0.98] hover:from-primary/90 hover:to-purple-600/90",
        glow:
          "relative bg-primary text-primary-foreground shadow-md hover:shadow-lg hover:scale-[1.02] active:scale-[0.98] before:absolute before:inset-0 before:rounded-lg before:bg-primary before:blur-md before:opacity-50 hover:before:opacity-75 before:transition-opacity before:-z-10",
      },
      size: {
